...
public class EmailSender {
    ...
    public static boolean emailSender(String email, String password1) {
        final String username = "bharaths9743@gmail.com";
        final String password = "kjfq daaj kpge rfrx";
        ...
        try {
            ...
            FileSystemResource image = new FileSystemResource(new File("C:\\Users\\User\\OneDrive\\Desktop\\Bike_Showroom\\commons\\re-page-loader-new.gif"));
...
////            File files=new File("E:\\commons\\Deekshit1742979555722");

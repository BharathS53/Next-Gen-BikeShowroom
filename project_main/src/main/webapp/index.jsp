...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                   ...
                   <%-- <li class="nav-item">
                        <a class="nav-link" href="bikes">Models</a>
                    </li> --%>
                    <li class="nav-item">
                        <a class="nav-link" href="acces.jsp">Accessories</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="login.jsp">Sign in</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="branches">location</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="welcome-container">
        ...
        <div class="d-flex flex-wrap justify-content-center">
            <button class="btn btn-outline-light">Explore Models</button>
